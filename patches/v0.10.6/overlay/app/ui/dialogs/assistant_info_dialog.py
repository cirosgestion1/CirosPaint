    ...
    def __init__(self, parent=None):
        ...
        sections = (
            (
                ...
                "El asistente consulta nombres, marcas, gamas, códigos, tipos de pintura, colores y cantidades disponibles.",
            ),
            (
                "Buscar alternativas",
                "Si necesitas una pintura que no tienes, el asistente puede comprobar si existe una alternativa adecuada dentro de tu propio inventario.\n\n"
                "Ciros Paint realiza la comparación utilizando la información real de las pinturas y su similitud de color, "
            ...
            (
                ...
                "El asistente puede ayudarte a modificar tu inventario mediante lenguaje natural. Puedes indicar que has comprado una pintura, "
            ...
            (
                "Futuras compras",
                "También puede consultar y gestionar las pinturas que quieras comprar más adelante.\n\n"
                "Por ejemplo:\n"
                "• Añade esta pintura a futuras compras.\n"
                "• ¿Qué pinturas tengo pendientes de comprar?\n\n"
                "Ciros Paint evita crear entradas duplicadas cuando una pintura ya está registrada.",
            ),
            (
            ...
            (
                "Analizar imágenes",
                "Puedes adjuntar imágenes relacionadas con pinturas para utilizarlas durante una conversación con el asistente.\n\n"
                "La imagen se envía a Gemini únicamente como parte de esa consulta y permite complementar el texto con información visual.",
            ),
            (
                ...
                "pero Ciros Paint no crea una memoria permanente de tus conversaciones.\n\n"
