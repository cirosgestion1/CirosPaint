...
class FavoritePaintAnalysisUiTests(unittest.TestCase):
    ...
    def test_results_dialog_has_three_visual_sections_when_paints_were_detected(self):
        result = PaintAnalysisResult(author_lines=("Test paint",), detected=(object(),), matches=(), missing=())
